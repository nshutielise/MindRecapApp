...
const faqs = [
  ...
  },
  {
    ...
    answer: "Currently, we are offering MindRecap Pro features completely free for everyone! You can process up to 10,000 characters per request and enjoy an ad-free experience."
  },
  {
    question: "Can the Plagiarism Checker scan uploaded files?",
    answer: "Yes, our Plagiarism Checker supports direct text input as well as file uploads (.pdf, .docx, .txt, .md, .csv). It compares your content against billions of web pages and academic databases to provide a comprehensive Similarity Score."
  }
];
